...
"""
Patch utility for STF files targeting HOL4P4

Patch performs the following:
* Remove usage of double quotes around control plane names
* Remove whitespace around comma separator for action arguments
"""
